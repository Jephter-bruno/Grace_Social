...
- [Grace Social Development Schema](grace-social-development-schema.md) — Check the dev PostgreSQL schema when API routes return 404/500; route code and database tables can drift independently.
