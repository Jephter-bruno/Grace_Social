...
export function StoryBar() {
  ...
  // Only stories with content can be viewed
  ...
  const handleStoryPress = (item: Story) => {
    ...
    // Other users' stories — open viewer if they have content
  ...
  return (
    <>
      ...
      {/* Only mount when open — guarantees fresh state and prevents
          always-mounted hooks (like useVideoPlayer) from running idle */}
      {viewerVisible && (
        <StoryViewer
